package TP.cs.cs07.view;

import java.util.Scanner;

import TP.cs.cs07.model.ColecaoDeMusica;
import TP.cs.cs07.model.ManipulaDataset;
import TP.cs.cs07.model.Musica;
import TP.cs.cs07.model.VetorDeMusica;
...
public class Main {
    public static void main(String[] args) {
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            ColecaoDeMusica colecao = new VetorDeMusica(1000);
            ManipulaDataset dataset = new ManipulaDataset("TP/cs/cs07/public/Dataset.csv", colecao);
            dataset.ler();

            System.out.println("Dados carregados com sucesso! Total de músicas: " + colecao.obterTotalDeMusicas());
